...
impl Location {
    ...
    pub fn force_in_bounds(&self, position: &GridPosition) -> Either<GridPosition, GridPosition> {
    ...
    pub fn is_in_bounds(&self, position: &GridPosition) -> bool {
    ...
    pub fn force_can_walk_on(&self, position: &GridPosition) -> Either<GridPosition, GridPosition> {
    ...
    pub fn can_walk_on(&self, position: &GridPosition) -> bool {
...
impl RealPosition {
    ...
    pub fn nearest_grid_position(&self) -> GridPosition {
        GridPosition {
